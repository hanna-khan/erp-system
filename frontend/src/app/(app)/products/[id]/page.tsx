        ...
        <TabsContent value="attributes">
          <div className="zr-card grid gap-4 p-5 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              ["Composition", isGarment ? "Printed lawn · RTW" : product.type === "Fabric" ? "100% Cotton" : "As per style card"],
              ["Construction", isGarment ? "Cut & sew 2-piece" : product.category === "Lawn 2026" ? "Plain weave" : "—"],
